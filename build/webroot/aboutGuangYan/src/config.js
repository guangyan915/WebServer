export default {
  // page1部分
  page1: {
    titleEn: 'I want to be a programmer who loves photography', //英文标题
    title: '想做一个热爱摄影的程序员', //中文标题
  },
  // page2部分
  page2: {
    authorImg: 'lgy.png', // 作者头像
    xinhui: '我叫李光炎，是一名24届应届生', // 幸会
    qiuzhi: 'C++开发/后台开发/客户端开发', // 求职意向
    guanyuwo: '喜欢摄影、跑步'
  },
  // page3部分
  page3: [{
  ...
  // page6部分
  page6: {
    github: 'https://github.com/guangyan915',
    bili: '',
    email: 'Mailto:guangyan915@163.com?Subject=邮箱标题&Body=邮箱内容！',
    zhihu: '',
